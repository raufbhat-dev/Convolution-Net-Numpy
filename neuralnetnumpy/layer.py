...
class Layer:
    def __init__(self, input_count, neruon_count, activation_func, layer_type_category, layer_type):
...
class Dropout(Layer):
    def __init__(self, input_count, neruon_count, activation_func, layer_type_category, layer_type, percentage):
        super().__init__(input_count, neruon_count, activation_func, layer_type_category, layer_type)
